...
class NgxUiLoaderService {
  ...
  readyToStart(loaderId, taskId, isForeground, time = DEFAULT_TIME) {
    ...
    this.loaders[loaderId].tasks[taskId] = Object.assign({}, this.loaders[loaderId].tasks[taskId], {
      isOtherRunning,
      startAt: Date.now()
    });
...
/** @nocollapse */
NgxUiLoaderService.ngInjectableDef = ɵɵdefineInjectable({
...
export {
  ...
  POSITION,
  SPINNER,
  NGX_UI_LOADER_CONFIG_TOKEN as ɵa,
  NgxUiLoaderComponent as ɵb,
  NgxUiLoaderBlurredDirective as ɵc,
  NGX_UI_LOADER_ROUTER_CONFIG_TOKEN as ɵd,
  NgxUiLoaderHttpInterceptor as ɵe,
  NGX_UI_LOADER_HTTP_CONFIG_TOKEN as ɵf
};
